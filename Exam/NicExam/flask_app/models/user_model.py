...
class User:
    ...
    def validate_registration( data ):
        ...
        if len( data[ 'first_name' ] ) < 3:
            flash( "Your first name needs to have at least 3 characters", "error_registration_first_name" )
            is_valid = False
        if len( data[ 'last_name' ] )  < 3:
            flash( "Your last name needs to have at least 3 characters", "error_registration_last_name" )
            is_valid = False
